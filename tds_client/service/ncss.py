...
class NetCDFSubsetService(StandardService):
    ...
    def get_subset(self, session=requests, **kwargs):
        ...
        NetCDFSubsetService._check_dependent_params(params, { 'latitude', 'longitude' })
        NetCDFSubsetService._check_dependent_params(params, { 'north', 'east', 'south', 'west' })
        
        # Check for mutually exclusive parameters.
        NetCDFSubsetService._check_exclusive_params(params, { 'latitude', 'longitude' }, { 'north', 'east', 'south', 'west' })
